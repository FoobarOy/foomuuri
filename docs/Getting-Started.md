...
Foomuuri depends on `nftables` (version 1.0.0 or higher), `python3-systemd`,
`python3-dbus` and `python3-gobject` (called `python3-gi` in some
distributions). Install those dependencies first. Older `nftables` will
